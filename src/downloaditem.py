...
class DownloadItem(QtWidgets.QWidget):
    def __init__(self, parent: QtWidgets.QWidget = ...) -> None:
        ...
        self.info = None
        self.ui.button_open.clicked.connect(self.on_button_clicked)
    ...
    def re_start(self):
        ...
        self.disconnect(self.info["thread"])
        ...
        thread.update_finished.connect(self.update_finished)
        thread.enable_restart.connect(self.enable_button)
        thread.start()
